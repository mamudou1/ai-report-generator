...
import { Report, ActiveReport, isSavedReport } from "@/lib/types";
...
export default function Home() {
  ...
  const reports      = (useQuery(api.reports.listReports) ?? []) as Report[];
  ...
  const activeId = activeReport && isSavedReport(activeReport)
    ? String(activeReport._id)
    : undefined;
